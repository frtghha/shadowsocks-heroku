> Fork 于 [shadowsocks-heroku](https://github.com/frtghha/shadowsocks-heroku) 项目
...
2. 请先自行通过Google/[Github](https://github.com/frtghha/shadowsocks-heroku/search?utf8=%E2%9C%93&q=&type=)寻找答案
3. 如果还没有解决，欢迎通过[ issue](https://github.com/frtghha/shadowsocks-heroku/issues?q=is%3Aissue+is%3Aclosed+label%3Asolved) 提问（贴日志和配置的时候注意隐藏密码&个人ip）
...
注册地址：https://signup.heroku.com/ （注册和部署过程可能需要梯子[#10](https://github.com/frtghha/shadowsocks-heroku/issues/10)，[#14](https://github.com/frtghha/shadowsocks-heroku/issues/14)）

## 部署
1. 点击 [![](https://www.herokucdn.com/deploy/button.png)](https://heroku.com/deploy?template=https://github.com/onplus/shadowsocks-heroku/tree/re)，[一键部署到heroku](https://heroku.com/deploy?template=https://github.com/frtghha/shadowsocks-heroku/tree/re)
